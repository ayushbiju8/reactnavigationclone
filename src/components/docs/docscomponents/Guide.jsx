...
function Guide() {
  ...
  return (
    <div className='Strarted'>
      <h1>Moving between screens</h1>
      <p>In the previous section, "Hello React Navigation", we defined a stack navigator with two routes (Home and Details), but we didn't learn how to let a user navigate from Home to Details (although we did learn how to change the initial route in our code, but forcing our users to clone our repository and change the route in our code in order to see another screen is arguably among the worst user experiences one could imagine).</p>
      ...
      <h3>Navigating to a new screen</h3>
      ...
      <h3>Navigate to a route multiple times</h3>
